...
if response.status_code == 200:
    ...
    if ol_container:
        ...
        for item in items:
            ...
            ubicacion   = contenido.find('div', class_='poly-component__location')

            


            imagens = ol_container.find_all('li', class_='ui-search-layout__item')
            ...
            if imagens:
                for imagen in imagens:
                    img_src    = imagen.find('img', class_='poly-component__picture')        
                    
                    imagen_src  = imagen['src'] if imagen else "No disponible"

                    print("Imagen URL:", imagen_src)
            ...
            if contenido:
                ...
                print("Portada:", portada.text.strip() if portada else "No disponible")
